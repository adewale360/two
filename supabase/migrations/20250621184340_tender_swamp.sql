/*
  ...
  1. Sample Data
    - Insert sample faculties, departments, profiles, courses, enrollments, and results
    - Create realistic academic data structure
    - Set up proper relationships between entities
  
  2. Data Structure
    - 820 students across all departments and levels
    - 40 lecturers across departments
    - Realistic course enrollments and results
    - Academic calendar and semester data
*/
...
BEGIN
    FOR i IN 1..50 LOOP
        ...
        INSERT INTO profiles (
            ...
            student_id_val,
            LOWER(REPLACE(student_names[i], ' ', '.')) || '@student.university.edu',
            student_names[i],
...
-- Update profiles foreign key constraints
