...
import { User, Mail, Phone, MapPin, Calendar, Edit, Save, X, Camera, Award, BookOpen, TrendingUp } from 'lucide-react';
    ...
    <div className="compact-spacing">
      ...
      <Card>
        <div className="grid grid-cols-1 lg:grid-cols-4 compact-grid">
          ...
          <div>
            <h4 className="compact-subheader text-gray-900 dark:text-white mb-3">Academic Info</h4>
            <div className="tight-spacing">
